...
// For instance, the wifi password may be different according to where the sensor is going to be used.
...
// HC-SR04: 5 measures per second is a good balance between reactivity and
// sensor stability (the datasheet recommends waiting at least 60ms between bursts)
const unsigned int NUMBER_OF_VALUES_PER_SECOND = 5;
const long INTERVAL = (1.0 / NUMBER_OF_VALUES_PER_SECOND) * 1000; // = 200 ms
